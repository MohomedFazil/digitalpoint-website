...
export function Hero() {
  return <section className="relative bg-white overflow-hidden pt-12 pb-20 lg:pt-20 lg:pb-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div className="z-10">
            <p className="text-[#0EA5E9] font-medium mb-4 tracking-wide text-sm">
          ...
          <div className="relative mt-10 lg:mt-0">
            ...
            {/* Floating Stats Card */}
            <div className="absolute -top-6 -right-4 lg:-right-12 bg-white p-6 rounded-xl shadow-xl border border-gray-100 max-w-xs z-20">
              <div className="flex items-start justify-between mb-2">
                <div>
                  <h3 className="text-3xl font-bold text-gray-900">490,000</h3>
                  <p className="text-xs text-gray-500 uppercase tracking-wider">
                    Units of Prints Produced in 2023
                  </p>
                </div>
              </div>
            ...
            <div className="absolute -bottom-10 -right-6 z-20">
              <div className="relative w-24 h-24 bg-white rounded-full shadow-lg flex items-center justify-center border-4 border-gray-100">
                <div className="absolute inset-0 border-2 border-dashed border-gray-300 rounded-full animate-spin-slow"></div>
                <Award className="h-10 w-10 text-[#E91E63]" />
                <div className="absolute -bottom-6 text-xs font-bold bg-black text-white px-2 py-1 rounded">
                  ISO 9001
                </div>
              </div>
            </div>
