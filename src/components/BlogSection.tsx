  ...
  return <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12">
          ...
          <a href="#" className="text-[#0EA5E9] font-medium flex items-center hover:underline">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden mb-6 bg-black">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-6xl font-thin text-white tracking-tighter">
                  hue<span className="text-[#E91E63]">.</span>
                </span>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#0EA5E9]/10 p-6 rounded-xl mt-4 flex items-center justify-between">
              <div>
                <span className="text-xs font-bold text-[#0EA5E9] uppercase tracking-wider mb-1 block">
                  New Guide
                </span>
              ...
              <div className="w-10 h-10 bg-[#0EA5E9] rounded-full flex items-center justify-center text-white flex-shrink-0">
